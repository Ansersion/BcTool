...
const BP_UINT8 <MACRO>_IS_ALARM = <ALARM>;
const BP_UINT16 <MACRO>_UNIT_ID = <UNIT_ID>;
const BP_UINT16 <MACRO>_PERMISSION = <PERMISSION>;
const BP_UINT8 <MACRO>_IS_DISPLAY = <DISPLAY>;
const BP_UINT8 <MACRO>_ACCURACY = <ACCURACY>;
const SigTypeU <MACRO>_CUSTOM_MIN_VAL = <CUSTOM_MIN_VAL>;
const SigTypeU <MACRO>_CUSTOM_MAX_VAL = <CUSTOM_MAX_VAL>;
const SigTypeU <MACRO>_CUSTOM_DEF_VAL = <CUSTOM_DEF_VAL>;
const BP_UINT16 <MACRO>_GROUP_ID = <GROUP_ID>;
const BP_EnumSignalMap <MACRO>_ENUM_MAP[] = 
{
<KEY_2_VALUE>
};
<CUSTOM_ENUM_LANG_SIZE>;
const BP_UINT8 <MACRO>_EN_STATISTICS = <STATISTICS>;
const BP_UINT8 <MACRO>_ALARM_CLASS = <ALARM_CLASS>;
const BP_UINT8 <MACRO>_DELAY_BEFORE_ALARM = <ALARM_DELAY_BEF>;
const BP_UINT8 <MACRO>_DELAY_AFTER_ALARM = <ALARM_DELAY_AFT>;
</SYSTEM_SIGNAL_CUSTOM_VALUE>
